...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#">Deposit Amount</a>
            </li>
            <li class="nav-item">
    ...
    <h1 style="text-align:center;">Deposit Amount</h1>
      <div class="layout">
    <form action ="depositAmount.do" method ="post">
            <div class="form-group row">
                <div class="col-sm-3"></div>
              <label for="" class="col-sm-2 col-form-label">Account Number :</label>
              <div class="col-sm-5">
                <input type="number" name="account_id" class="form-control" id="" placeholder="Enter Account Number" required>
              </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3"></div>
              ...
              <div class="col-sm-5">
                <input type="number" name = "amount"class="form-control" id="amt" placeholder="Enter Amount To Withdraw" required>
              </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3"></div>
