...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
    <h1 style="text-align:center;">Update Account Details</h1>
      <div class="layout">
    <form action="Details.do" method="post">
            <div class="form-group row">
                    <div class="col-sm-3"></div>
                  <label for="" class="col-sm-2 col-form-label">Account Id :</label>
                  <div class="col-sm-5">
                    <input type="number" name="account_id" class="form-control" id="" placeholder="" required>
                  </div>
                </div>
            <div class="form-group row">
                <div class="col-sm-3"></div>
