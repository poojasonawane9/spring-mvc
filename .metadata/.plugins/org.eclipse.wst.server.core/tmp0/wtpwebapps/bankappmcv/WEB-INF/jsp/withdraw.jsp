...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <h1 style="text-align:center;">Withdraw Amount</h1>
      <div class="layout">
    <form action = "withdrawAmount.do" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-5">
                <input type="number" name="account_balance" class="form-control" id="amt" placeholder="Enter Amount To Withdraw" required>
              </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-3"></div>
